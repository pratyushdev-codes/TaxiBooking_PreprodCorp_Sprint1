        ...
        <div className="min-h-screen bg-white flex flex-col items-center p-8">
            ...
            <div className="mb-12 flex flex-col items-center gap-4">
                ...
                <div className="flex justify-center gap-12 mb-8">
                    <button class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Download Invoice</button>
                 <Link
                        to='/ride'  >
                    <button class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Pay the driver</button>
                    </Link>
                </div>
            ...
            <div className="w-full max-w-md text-center">
                <h3 className="text-gray-600 mb-4 text-2xl font-semibold">Rate the driver</h3> {/* Centered and larger font size */}
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex items-center justify-between">
                        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Share your feedback</button>
                        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contact Support</button>
                    </div>
                    ...
                    <div className="flex flex gap-4 items-center justify-between">
                        <div>
                            ...
                            <button className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Book another ride</button>
                        </div>
